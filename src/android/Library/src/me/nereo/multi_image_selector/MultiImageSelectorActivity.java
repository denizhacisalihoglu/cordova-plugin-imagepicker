...
public class MultiImageSelectorActivity extends FragmentActivity implements MultiImageSelectorFragment.Callback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(fakeR.getId("layout", "activity_multiimage"));
        ...
        // 返回按钮
        findViewById(fakeR.getId("id", "btn_back")).setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void updateDoneText(){
        mSubmitButton.setText(String.format("%s(%d/%d)",
                getString(fakeR.getId("string", "action_done")), resultList.size(), mDefaultCount));
    }
